...
public class DrawDonut extends JDialog {
	...
	public DrawDonut() {
		...
		{
			JLabel lblNewInnerR = new JLabel("Enter inner radius");
			lblNewInnerR.setForeground(Color.RED);
			GridBagConstraints gbc_lblNewInnerR = new GridBagConstraints();
			gbc_lblNewInnerR.insets = new Insets(0, 0, 0, 5);
			gbc_lblNewInnerR.gridx = 1;
			gbc_lblNewInnerR.gridy = 1;
			contentPanel.add(lblNewInnerR, gbc_lblNewInnerR);
		}
		{
			txtInnerR = new JTextField();
			txtInnerR.setForeground(Color.RED);
			GridBagConstraints gbc_txtInnerR = new GridBagConstraints();
			gbc_txtInnerR.gridwidth = 3;
			gbc_txtInnerR.fill = GridBagConstraints.HORIZONTAL;
			gbc_txtInnerR.gridx = 3;
			gbc_txtInnerR.gridy = 1;
